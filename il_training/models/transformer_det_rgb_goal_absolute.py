...
# --- 2. Main Model: Visual Only -> Absolute Position ---
class Transformer_Visual_Absolute(nn.Module):
    def __init__(
        self,
        seq_len: int,          
        future_steps: int,     
        ...
        # --- Projection ---
        # Projects Visual Features directly to Transformer Dim
    ...
    def forward(self, rgb_seq, goal_image):
        """
        Args:
        ...
        # --- 3. Assemble Input ---
        # Sequence: [Image_1, Image_2, ..., Image_N, Goal_Image]
